  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="border border-rule bg-card p-6 shadow-card">
        ...
        <p className="mt-3 text-sm leading-6 text-faint">Scheduled and test-email briefs are hidden until delivery credentials, monitoring, and end-to-end verification are complete.</p>
      </div>
